...
po predefinovaných trajektóriach. Takiež zabezpečuje bezpečnosť pri riadené dronov, vyhnutie sa kolíziám a 
pri simulačnom prostredí aj konverziu videa
videa do GStreameru (reálny dron streamuje priamo cez GStreamer), ktorý následne posiela video do frontendovej aplikácie.
