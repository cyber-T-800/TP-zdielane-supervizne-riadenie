...
{
public:
  MavrosInterface(rclcpp::Node* node, const std::string& mavros_ns);
  ...
  // pose freshness (important for swarm safety checks)
  rclcpp::Time last_pose_time() const { return last_pose_time_; }
